...
export default function Home() {
  ...
  return (
    <div>
      {/* top */}
      <div className='flex flex-col gap-6 p-28 px-3 mx-auto max-w-5xl'>
       ...
       <div className='text-gray-400 text-xs sm:text-sm'>Estate Easy is the best place to find your next perfect place to live.
        <br/>
        With a wide range of listings, we are sure you will find a home that suits your needs.
       </div>
