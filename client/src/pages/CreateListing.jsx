        ...
        <main className="p-3 max-w-4xl mx-auto">
            ...
            <form onSubmit={handleSubmit} className="flex flex-col sm:flex-row gap-4">
                ...
                <div className="flex flex-col gap-4 flex-1">
                    ...
                    <button disable={loading || uploading} className="p-3 bg-slate-700 text-white rounded-lg uppercase hover:opacity-85 disabled:opacity-75" >{loading ? 'Creating...' : 'Create'}</button>
